...
export function Hero07({
  ...
  const mediaElement = landscapeImage && (
    <div className="relative w-full overflow-hidden max-w-7xl mx-auto px-6 pt-6">
      <div
        className={cn(
      ...
      >
        <div
          aria-hidden
          className="bg-background/10 pointer-events-none absolute inset-0 z-10 mix-blend-overlay"
        />
        <img
          src={landscapeImage}
          alt={landscapeAlt}
          decoding="async"
          className="aspect-[16/9] sm:aspect-[21/9] w-full object-cover object-center max-h-[500px]"
        />
      </div>
    </div>
  )
